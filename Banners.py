...
def banner4():
  ...
  banner = """
    ...
    ╚═════╝ ╚═╝     ╚═╝╚═════╝       ╚═════╝  ╚════╝ ╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝      ╚═════╝  ╚════╝  ╚════╝
                                                                        ...
                                                                        \033[32mv.10.1\033[33m (Разработчик: \033[31mДаня Париж\033[33m)   
                                                                            Ваша система - Windows/Другая
      _________________________________________________________________________________________  
      |                                                                                       |
      | \033[34mVK\033[33m - https://vk.com/danyaparis                                                    |
      |                                                                                       |      
...
def banner1an():
    ...
    ┃┗━┛┃┃┃┃┗━┛┣━━┫┗━┛┃┗┛┃┃┃┃┗━┛┃┃━┫┣━━┫┗━┛┃┗━┛┃┗━┛┃
    ┗━━━┻┻┻┻━━━┛  ┗━━━┻━━┻┻┻┻━━━┻━━┻┛  ┗━━━┻━━━┻━━━┛
                  v.10.1 (Разработчик: Даня Париж\033)
                       Ваша система - Linux/Android
                              Сервисы - 320
"""
    r=0
...
def banner2an():
    ...
    ██████╔╝██║ ╚═╝ ██║██████╔╝      ██████╦╝╚█████╔╝██║ ╚═╝ ██║██████╦╝███████╗██║  ██║      ██████╔╝╚█████╔╝╚█████╔╝
    ╚═════╝ ╚═╝     ╚═╝╚═════╝       ╚═════╝  ╚════╝ ╚═╝     ╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝      ╚═════╝  ╚════╝  ╚════╝
                                                                       v.10.1 (Разработчик: Даня Париж)
                                                                            Ваша система - Windows/Другая
      _________________________________________________________________________________________
      |                                                                                       |
      | VK - https://vk.com/danyaparis                                                    |
      |                                                                                       |
      |_______________________________________________________________________________________|
